...
begin
    if (rst) begin
        ...
        else if (red_state == s_red_wait_from_second) begin   
...
localparam s_load_domain_sep             =   6;
localparam s_wait_for_collision_1        =   7;
localparam s_wait_for_collision_2        =   8;
localparam s_wait_for_collision_3        =   9;
localparam s_wait_for_collision_4        =   10;
...
begin
    ...
    case (state_shake)
        ...
        s_wait_for_collision_1, s_wait_for_collision_2, 
        s_wait_for_collision_3, s_wait_for_collision_4: begin
			shake_input_type = 2'b01;
            if (squeeze_ctrl) begin
                seed_valid_internal = 1'b1;
            end
