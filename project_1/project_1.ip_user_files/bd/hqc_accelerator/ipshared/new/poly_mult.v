...
localparam S_REDUCTION_START         =   6;
localparam S_WAIT_REDUCTION          =   7;
localparam S_REDUCTION_DONE          =   8;
...
reg [`CLOG2(RAMSIZE/2)-1:0] addr_0_int_red_mem; //reg [ADDR_WIDTH-1:0] addr_0_int_red_mem;
reg [`CLOG2(RAMSIZE/2)-1:0] addr_1_int_red_mem; // reg [ADDR_WIDTH-1:0] addr_1_int_red_mem;
