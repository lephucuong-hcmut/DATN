module hqc_rmdecod_top #(
    ...
    hqc_rmdecod_expnsum #(.PARAM_SECURITY (PARAM_SECURITY)) EXPANSE_AND_SUM (
        .clk_i        (clk_i            ),
        .rst_ni       (rst_ni           ),
        .start_i      (eas_start        ),
    ...
    hqc_rmdecod_hadamard #(.PARAM_SECURITY (PARAM_SECURITY)) HADAMARD (
        .clk_i        (clk_i         ),
        .rst_ni       (rst_ni        ),
        .start_i      (had_start     ),
        .din0_i       (eas_dout0     ),
    ...
    hqc_rmdecod_findpeaks #(.PARAM_SECURITY (PARAM_SECURITY)) FIND_PEAKS (
        .clk_i        (clk_i         ),
        .rst_ni       (rst_ni        ),
        .start_i      (peak_start    ),
        .din0_i       (had_dout0     ),
    ...
    hqc_rmdecod_ctrl #(.PARAM_SECURITY (PARAM_SECURITY)) RM_DECOD_CTRL (
        .clk_i             (clk_i            ),
        .rst_ni            (rst_ni           ),
        .start_i           (start_i          ),
        .busy_o            (busy_o           ),
