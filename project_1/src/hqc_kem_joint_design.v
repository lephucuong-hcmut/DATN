...
#( 
	...
	parameter LOG_RAMDEPTH = `CLOG2(RAMDEPTH),
     ...
     parameter CT_DESIGN = 2'b01, // CT_DESIGN = 1 Constant time design, CT_DESIGN = 0 Default Design 
...
assign shake_din_valid  = (operation == KEYGEN)? shake_din_valid_kg :
                          ...
                          (operation == DECAPSULATION && encap_inside_decap == 0)? shake_din_valid_d : 
                           0;
assign shake_din_ready_d   = (operation == DECAPSULATION && encap_inside_decap == 0)? shake_din_ready: 0;
assign shake_din         = (operation == KEYGEN)?  shake_din_kg:
                           (operation == ENCAPSULATION || encap_inside_decap)?  shake_din_e:
                           (operation == DECAPSULATION && encap_inside_decap == 0)?  shake_din_d:
                           0;
assign shake_dout_ready  = (operation == KEYGEN)? shake_dout_ready_kg:
                           ...
                           (operation == DECAPSULATION && encap_inside_decap == 0)? shake_dout_ready_d:
                           0;
...
assign shake_force_done  = (operation == KEYGEN)? shake_force_done_kg:
                           ...
                           (operation == DECAPSULATION && encap_inside_decap == 0)? shake_force_done_d:
                           0;
assign shake_dout_valid_d   = (operation == DECAPSULATION && encap_inside_decap == 0)? shake_dout_valid : 0;
`else
assign shake_din_valid  = (operation == KEYGEN)? shake_din_valid_kg :
                          (operation == ENCAPSULATION || encap_inside_decap)? shake_din_valid_e:
                          0;
